...
- GAL1155E: Programming logic error: Unable to compile the regex pattern for the provided token ID. Reason: '{}'
- GAL1156E: The provided token ID, '{}', does not match formatting requirements. The token ID can contain any character in the 'a'-'z', 'A'-'Z', '0'-'9', '-' (dash), or '_' (underscore) ranges only.
