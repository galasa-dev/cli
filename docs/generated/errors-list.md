...
- GAL1089E: Unable to unmarshal the galasactl.properties file.
- GAL1090E: Could not get JWT from API server. Reason: '{}'
- GAL1091E: Could not get JWT from bearer token file '{}'. Reason: '{}'. Please ensure you are authenticated by running 'galasactl auth login'
