...
var (
	...
	GALASA_ERROR_INVALID_PKG_RESERVED_WORD                = NewMessageType("GAL1044E: Invalid Java package name. Package name '%s' contains the reserved java keyword '%s'."+SEE_COMMAND_REFERENCE, 1044, STACK_TRACE_WANTED)
