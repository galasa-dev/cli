...
var (
	...
	// TODO: create more age errors
	GALASA_ERROR_INVALID_AGE = NewMessageType("GAL1070E: Badly formed age parameter '%s'. Expected it to be of the form FROM:TO or FROM with the time units of 'w' (week), 'd' (day), or 'h' (hour).", 1070, STACK_TRACE_NOT_WANTED)
