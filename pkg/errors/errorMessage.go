...
var (
	...
	GALASA_ERROR_QUERY_NAMESPACE_FAILED              = NewMessageType("GAL1096E: Could not query namesapace results.", 1096, STACK_TRACE_WANTED)
	...
	GALASA_ERROR_PUT_PROPERTY_FAILED                 = NewMessageType("GAL1099E: Property '%v' could not be updated. Reason: '%s'", 1099, STACK_TRACE_NOT_WANTED)
	...
	GALASA_ERROR_POST_PROPERTY_FAILED                = NewMessageType("GAL1103E: Property '%v' could not be created. Reason: '%s'", 1103, STACK_TRACE_WANTED)
	GALASA_ERROR_POST_PROPERTY_STATUS_CODE_NOT_OK    = NewMessageType("GAL1104E: Status Code when creating property '%v'. Reason: '%s'", 1104, STACK_TRACE_NOT_WANTED)
