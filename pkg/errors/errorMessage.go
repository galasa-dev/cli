...
var (
	...
	GALASA_ERROR_INVALID_FLAG_VALUE                       = NewMessageType("GAL1075E: Flag value '%s' is invalid. Expected it to be in format starting with letters, and ending in a number with no non-alphanumeric characters.", 1075, STACK_TRACE_NOT_WANTED)
