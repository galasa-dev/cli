...
var (
	...
	GALASA_ERROR_UPDATE_MONITOR_REQUEST_FAILED           = NewMessageType("GAL1218E: Failed to update a monitor named '%s'. Sending the put request to the Galasa service failed. Cause is %v", 1218, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_UPDATE_MONITOR_NO_RESPONSE_CONTENT      = NewMessageType("GAL1219E: Failed to update a monitor named '%s'. Unexpected http status code %v received from the server.", 1219, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_UPDATE_MONITOR_RESPONSE_BODY_UNREADABLE = NewMessageType("GAL1220E: Failed to update a monitor named '%s'. Unexpected http status code %v received from the server. Error details from the server could not be read. Cause: %s", 1220, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_UPDATE_MONITOR_UNPARSEABLE_CONTENT      = NewMessageType("GAL1221E: Failed to update a monitor named '%s'. Unexpected http status code %v received from the server. Error details from the server are not in a valid json format. Cause: '%s'", 1221, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_UPDATE_MONITOR_SERVER_REPORTED_ERROR    = NewMessageType("GAL1222E: Failed to update a monitor named '%s'. Unexpected http status code %v received from the server. Error details from the server are: '%s'", 1222, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_UPDATE_MONITOR_EXPLANATION_NOT_JSON     = NewMessageType("GAL1223E: Failed to update a monitor named '%s'. Unexpected http status code %v received from the server. Error details from the server are not in the json format.", 1223, STACK_TRACE_NOT_WANTED)
