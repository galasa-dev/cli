...
var (
	...
	GALASA_ERROR_NO_RUNNAME_OR_AGE_SPECIFIED    = NewMessageType("GAL1080E: Neither a runname or an age have been specified. Either specify a runname or an age of the tests you want to see.", 1080, STACK_TRACE_NOT_WANTED)
