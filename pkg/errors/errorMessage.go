...
var (
	...
	GALASA_ERROR_MISSING_SECRET_NAME                    = NewMessageType("GAL1172E: Invalid secret name provided. The name provided with the --name flag cannot be empty or only contain spaces.", 1172, STACK_TRACE_NOT_WANTED)
