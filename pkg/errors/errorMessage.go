...
var (
	...
	GALASA_ERROR_GET_SECRET_REQUEST_FAILED               = NewMessageType("GAL1179E: An attempt to get a secret named '%s' failed. Sending the delete request to the Galasa service failed. Cause is %v", 1179, STACK_TRACE_NOT_WANTED)
	...
	GALASA_ERROR_GET_SECRETS_REQUEST_FAILED               = NewMessageType("GAL1185E: Failed to get secrets. Sending the delete request to the Galasa service failed. Cause is %v", 1185, STACK_TRACE_NOT_WANTED)
