...
var (
	...
	GALASA_ERROR_RESOURCES_RESP_CLIENT_ERROR             = NewMessageType("GAL1113E: Failure reported by the Galasa Ecosystem. The Ecosystem believes there is a problem with this client program. "+
		"This could indicate that the client and Ecosystem have a mis-match in their versions, and the client needs to be upgraded, or downgraded to match. Use the galasactl version` to find the version of this tool.\nHTTP Response status code reported: %s\nThe list of errors returned: '%s'", 1113, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_RESOURCES_RESP_SERVER_ERROR     = NewMessageType("GAL1114E: A failure was reported from the Galasa Ecosystem where the Ecosystem is at fault. Please contact your Galasa Ecosystem adminstrator.\nHTTP Response status code reported: %s\nThe list of errors returned: %s", 1114, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_RESOURCES_RESP_UNEXPECTED_ERROR = NewMessageType("GAL1115E: An unexpected response was received from the Galasa Ecosystem. Please collect a log using the --log option and contact your Galasa Ecosystem adminstrator.\nHTTP Response status code reported: %s\nThe list of errors returned: %s", 1115, STACK_TRACE_NOT_WANTED)
