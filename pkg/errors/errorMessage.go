...
var (
	...
	GALASA_ERROR_INVALID_PROPERTIES_FLAG_COMBINATION      = NewMessageType("GAL1098: Property --name cannot be set alongside --prefix or --suffix.", 1098, STACK_TRACE_WANTED)
