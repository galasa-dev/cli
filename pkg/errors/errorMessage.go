...
var (
	...
	GALASA_ERROR_MISSING_USER_LOGIN_ID_FLAG      = NewMessageType("GAL1155E: name is a null or an empty string.", 1155, STACK_TRACE_NOT_WANTED)
	GALASA_ERROR_LOGIN_ID_NOT_SUPPORTED          = NewMessageType("GAL1156E: '%s' is not supported as a valid value. Currently, a value of 'me' is supported only.", 1156, STACK_TRACE_NOT_WANTED)
