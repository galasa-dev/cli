...
// ------------------------------------------------------------------------------------------------
func NewAuthTokensCommand(authCommand GalasaCommand) (GalasaCommand, error) {
...
func (cmd *AuthTokensCommand) createAuthTokensCobraCmd(authCommand GalasaCommand) (*cobra.Command, error) {
