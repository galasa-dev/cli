...
const (
	...
	BOOTSTRAP_PROPERTY_NAME_LOCAL_JVM_LAUNCH_DEBUG_PORT string = "framework.jvm.local.launch.debug.port"
	...
	BOOTSTRAP_PROPERTY_NAME_LOCAL_JVM_LAUNCH_DEBUG_MODE string = "framework.jvm.local.launch.debug.mode"
)
