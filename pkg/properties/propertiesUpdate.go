...
func updateCpsProperty(namespace string,
	...
	apicall := restClient.ConfigurationPropertyStoreAPIApi.PutCpsProperty(context, namespace, name) //THIS NEEDS TO BE CHANGED TO PUT ONCE API HAS BEEN UPDATED
	...
	if err != nil {
		...
		if httpResponse.StatusCode != http.StatusOK {
			...
			err = galasaErrors.NewGalasaError(galasaErrors.GALASA_ERROR_PUT_PROPERTY_STATUS_CODE_DOESNT_MATCH, errString)
		}
	}
