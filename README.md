...
This command will reset a running test that is either stuck in a timeout condition or looping, by requeing the test.
...
This command will cancel a running test. It will not delete any information that is already stored in the RAS about the test, it will only cancel the execution of the test.
